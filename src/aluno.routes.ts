...
import { checkAuth } from "./auth.middeware";

export const alunosRoutes = Router();

// GET /alunos
alunosRoutes.get("/alunos", checkAuth, (req, res) => {
  return res.json(alunos);
});

// GET /alunos/medias
alunosRoutes.get("/alunos/medias", checkAuth, (req, res) => {
...
alunosRoutes.get("/alunos/aprovados", checkAuth, (req, res) => {
...
// GET /alunos/:id
alunosRoutes.get("/alunos/:id", checkAuth, (req, res) => {
...
// POST /alunos
alunosRoutes.post("/alunos", checkAuth, (req, res) => {
...
// PUT /alunos/:id
alunosRoutes.put("/alunos/:id", checkAuth, (req, res) => {
  const id = Number(req.params.id);
  const aluno = alunos.find((a) => a.id === id);
...
// DELETE /alunos/:id
alunosRoutes.delete("/alunos/:id", checkAuth, (req, res) => {
  const id = Number(req.params.id);
